...
def training(model, x, y):
    ...
    #
    # for start_idx in range(0, len(x) - minibatch_size + 1, minibatch_size):
    #     x_batch = x[start_idx:start_idx + minibatch_size]
    #     y_batch = y[start_idx:start_idx + minibatch_size]
